...
author: IRNAS - Symbiolab - Vitaprint
...
1. substitute ... wiht your working directory path in the code
	
	os.chdir(r'...')

2. follow the python console and input the necessary parameters
3. a .gcode file with [todaysdate]-filename.gcode should appear in your working directory
...
"""here insert the working directory path"""
import os
os.chdir(r'.....')
